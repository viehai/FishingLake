...
namespace FishingLake.BLL.Services
{
    public class CustomerService
    {
        ...
        {
            var bookings = _repo.GetBookingsByOwner(ownerId); // lấy Booking theo chủ hồ

            var grouped = bookings
                .GroupBy(b => b.User.Phone) // hoặc b.User.Id nếu đảm bảo ID không trùng
                .Select(g =>
                {
            ...
            return grouped
                ...
                .ThenByDescending(u => u.TotalBookings)
                .ToList();
        }
